...
% Last Modified by GUIDE v2.5 09-Mar-2020 21:35:12
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
smooth_data.method=get(handles.popupmenu1,'string');
key=get(handles.popupmenu1,'value')
smooth_data.method=smooth_data.method(key);
smooth_data.method=smooth_data.method{:};
smooth_data.Window=num2str(get(handles.edit1,'string'));
smooth_data.ErrCrit=num2str(get(handles.edit2,'string'));
save('./tmp_data/smooth_data.mat','smooth_data');
