...
SBeA_struct_path = ['Z:\hanyaning\multi_mice_test\Social_analysis\' ...
    'data\figs\fig4\panel_6\social_struct'];
save_path = ['Z:\hanyaning\multi_mice_test\Social_analysis\' ...
    'data\figs\fig4\panel_6\social_struct\recluster_data'];
videopath = rootpath;
cutvideoname = 'sbeapath_20230201_watershed';
mkdir(save_path)
...
%% create savelist
savelist_cell = recluster_savelist_3_no_dist(...
    ReMap_move_cell,Seglist_move_cell,...
    ReMap_speed_cell,Seglist_speed_cell);
%% create data_sample_cell
[data_sample_cell,net,info] = ...
    init_data_sample_cell_3_big_data_dl_no_dist(...
    savelist_cell,data_move_cell,data_speed_cell,fileNames);
...
save([save_path,'\SBeA_data_sample_cell_20230201.mat'],'data_sample_cell');
save([save_path,'\SBeA_dist_mat_all_20230201.mat'],'dist_mat_all','-v7.3');
save([save_path,'\SBeA_wc_struct_20230201.mat'],'wc_struct');
