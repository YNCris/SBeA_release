function mesh_mouse(coords3d, i)
...
tetramesh(DT,'FaceColor','b','FaceAlpha',0.8,'linewidth',0.1);
% grid on;
% xlim([-300 300])
% ylim([-300 300])
% zlim([-20 200])
...
DT = delaunayTriangulation(X',Y',Z');
tetramesh(DT,'FaceColor','c','FaceAlpha',0.8,'linewidth',0.1);
hold on;
...
DT = delaunayTriangulation(X',Y',Z');
tetramesh(DT,'FaceColor','c','FaceAlpha',1,'linewidth',0.1);