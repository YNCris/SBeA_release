...
warp_mouse1 = imagesc(XX1(1,:),YY1(:,1)',image1);
...
warp_mouse2 = imagesc(XX2(1,:),YY2(:,1)',image2);
...
set(gca,'ZTickLabel',[])
% set(gca,'ZLim',[-10,40])
tempy = [temp1(2,:),temp2(2,:)];
tempx = [temp1(1,:),temp2(1,:)];
set(gca,'YLim',[-10,40])
set(gca,'XLim',[min(tempx,[],'all'),max(tempx,[],'all')])
% title('x-z')
xlabel('x-z')
...
set(gca,'XTickLabel',{0:(180/inter_size):(180-(180/inter_size)),'      180 min'})
ylabel('Classes')
box off
%%
toc
% tic
% hall.Renderer = 'Painters';
% print(hall,[rootpath,'\fig3_V1.pdf'],'-dpdf','-r0');
