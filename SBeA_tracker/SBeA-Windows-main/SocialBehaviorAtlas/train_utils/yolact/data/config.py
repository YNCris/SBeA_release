from SocialBehaviorAtlas.train_utils.yolact.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
cfg = yolact_plus_resnet50_config.copy()

def sbea_set_cfg(sbea_config):
    """ Sets the active config. Works even if cfg is already imported! """
    global cfg

    # Note this is not just an eval because I'm lazy, but also because it can
    # be used like ssd300_config.copy({'max_size': 400}) for extreme fine-tuning
    cfg = sbea_config.copy()
