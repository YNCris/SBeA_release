...
videopath = rootpath;
cutvideoname = 'sbeapath_20221212_watershed';
mkdir(save_path)
...
save([save_path,'\SBeA_data_sample_cell_20221209.mat'],'data_sample_cell');
save([save_path,'\SBeA_dist_mat_all_20221209.mat'],'dist_mat_all','-v7.3');
save([save_path,'\SBeA_wc_struct_20221209.mat'],'wc_struct');
