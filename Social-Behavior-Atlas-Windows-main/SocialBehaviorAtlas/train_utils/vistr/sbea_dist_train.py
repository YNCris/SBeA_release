...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  8 10:17:02 2021
vistr for distributed training
@author: yaninghan
"""
"""
...
def sbea_vistr_distributed_train(dataset_info,train_info,workroot):
    #%%
    ...
    my_args.ytvos_path = fakevispath  # '/home/dltest/vistr/data/ytvos'
    # args.ytvos_path = '/home/dltest/vistr-2/data/SBM-VIS-VIStR-12'

    my_args.output_dir = workroot + '/models/vistr/' + train_info['VIS_model'][0:-4]
    my_args.pretrained_weights = workroot + '/models/vistr/384_coco_r101.pth'
    my_args.epochs = train_info['VIS_epochs']
    my_args.num_queries = dataset_info['Mouse_Num'] * my_args.num_frames
    my_args.num_out = dataset_info['Mouse_Num']

    if my_args.output_dir:
        Path(my_args.output_dir).mkdir(parents=True, exist_ok=True)


    proc_num = 8 # number of process
    mp.spawn(main, nprocs=proc_num, args=my_args)
