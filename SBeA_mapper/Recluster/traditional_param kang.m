...
%         pause
        ...
        tradparam_cell{m,5} = speed_rgbim;
        tradparam_cell{m,6} = mean_V;
        tradparam_cell{m,7} = active_quan;
        tradparam_cell{m,8} = mean_eng;
        tradparam_cell{m,9} = anxi_index;
        %% 进度控制
        disp(m)
    end
end
