...
%% precision compare
hpc = subplot('Position',[0.48,0.22,0.15,0.4]);
...
kd_dlc_x = zeros(npoints,size(y_dlc,2));
kd_sbea_y = zeros(npoints,size(y_sbea,2));
kd_dlc_y = zeros(npoints,size(y_dlc,2));
...
subplot('Position',[0.24,0.55,0.11,0.11])
